...
实现标准的 ResNet-18 与 ResNet-34 架构
...
class ResNet2D(nn.Module):
    ...
    def __init__(
        ...
        self.layer1 = self._make_layer_from_cfg(block, self.channel_cfg["layers"][0], dropout_p=dropout_p)
        self.layer2 = self._make_layer_from_cfg(block, self.channel_cfg["layers"][1], dropout_p=dropout_p)
        self.layer3 = self._make_layer_from_cfg(block, self.channel_cfg["layers"][2], dropout_p=dropout_p)
        self.layer4 = self._make_layer_from_cfg(block, self.channel_cfg["layers"][3], dropout_p=dropout_p)
    ...
    def _make_layer_from_cfg(self, block, layer_cfg, dropout_p=0.0):
        ...
        for block_cfg in layer_cfg["blocks"]:
            downsample = self._make_downsample(block_cfg["in_channels"], block_cfg.get("downsample"))
            layers.append(
                block(
